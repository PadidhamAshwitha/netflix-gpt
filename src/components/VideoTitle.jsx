...
const VideoTitle = ({title,overview,poster_path}) =>{
    return (
        <div className="pt-50 pl-20 w-screen aspect-video absolute bg-gradient-to-r from-black">
            <img 
            ...
            <div>
                <button className = "m-2 p-2 px-10 bg-white hover:opacity-80 rounded-lg text-black"> ▶ Play</button>
                <button className = "m-2 p-2 px-10 bg-gray-500 hover:opacity-80 rounded-lg text-white">More Info </button>
            </div>
        </div>
